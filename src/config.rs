...
pub struct AppConfig {
    ...
    pub host: String,      // TTS_GATEWAY_SERVICE_LISTEN_ADDRESS
    pub http_port: u16,    // TTS_GATEWAY_SERVICE_HTTP_PORT
    pub grpc_port: u16,    // TTS_GATEWAY_SERVICE_GRPC_PORT
...
impl AppConfig {
    pub fn load() -> Result<Self> {
        let builder = Config::builder()
            ...
            .set_override_option("http_port", env::var("TTS_GATEWAY_SERVICE_HTTP_PORT").ok())?
            ...
            // Varsayılan Hedefler (mTLS için https şart)
