    ...
    pub fn load() -> Result<Self> {
        let builder = Config::builder()
            ...
            .set_override_option(
                ...
                env::var("TTS_COQUI_SERVICE_URL").ok(),
            )?
            ...
            .set_default(
                ...
                "/sentiric-certificates/certs/tts-gateway-service.crt",
            )?
            .set_default(
                "tts_gateway_service_key_path",
                "/sentiric-certificates/certs/tts-gateway-service.key",
            )?;
